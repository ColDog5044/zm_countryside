...
DataSources.BuyablePerksDataSource = DataSourceHelpers.ListSetup("BuyablePerksDataSource", function(InstanceRef)
    ...
    -- Harry's perks
    AddPerkEntry("Electric Cherry", 2000, "perk.electriccherry", "ui_purchasemenu_electriccherry", "Drink to shock nearby enemies on reload.")
    AddPerkEntry("PhD Flopper", 2000, "perk.phdflopper", "ui_purchasemenu_phdflopper", "Drink to negate explosive damage and create a blast when diving.")
    AddPerkEntry("Vulture Aid", 3000, "perk.vultureaid", "ui_purchasemenu_vultureaid", "Drink to see wallbuys, ammo, and enemies through walls.")
    AddPerkEntry("Tombstone", 2000, "perk.tombstone", "ui_purchasemenu_tombstone", "Drink to drop a tombstone on death.")
    AddPerkEntry("Elemental Pop", 6000, "perk.combat_efficiency", "ui_purchasemenu_elementalpop", "Drink to trigger a random ammo mod effect.")

    -- Sphynx's perks
    AddPerkEntry("Death Perception", 2000, "perk.tracker", "ui_purchasemenu_deathperception", "Drink to see enemies through walls and gain critical hit damage.")
